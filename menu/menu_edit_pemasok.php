                ...
                <form name="form" method="post" action="../client/proses_pemasok.php">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="input_nama_pemasok" name="nama_pemasok" value="<?= $r->nama_pemasok ?>">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="input_jenis_kelamin" class="form-label">Jenis Kelamin</label>
                            <input type="text" class="form-control" id="input_jenis_kelamin" name="jenis_kelamin" value="<?= $r->jenis_kelamin ?>">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="input_alamat" class="form-label">Alamat</label>
                            <input type="text" class="form-control" id="input_alamat" name="alamat" value="<?= $r->alamat ?>">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="input_telp" class="form-label">No Telepon</label>
                            <input type="text" class="form-control" id="input_no_telp" name="no_telp" value="<?= $r->no_telp ?>">
                        </div>
                    </div>
